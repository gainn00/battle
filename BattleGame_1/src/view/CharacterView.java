...
import Players.Draco;
import Players.ExpectoPatronum;
import Players.Expelliarmus;
import Players.Harry;
import Players.Hermione;
import Players.Protego;
import Players.Ron;
import Players.Stupefy;
import Players.마법사;
...
public class CharacterView extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CharacterView frame = new CharacterView();
	...
	public CharacterView() {
		...
		gameStartButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				new GameActView(p1,p2).setVisible(true);
				dispose();
		...
		dracoPicture1.setIcon(new ImageIcon(CharacterView.class.getResource("/image/Draco.png")));
		...
		dracoButton1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				p1 = new Draco("드레이코", 95, 100, new ExpectoPatronum("ExpectoPatronum", 15, 10),"Draco.png");
		...
		hermionePicture1.setIcon(new ImageIcon(GameActView.class.getResource("/image/Hermione.png")));
		...
		hermioneButton1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				p1 =  new Hermione("헤르미온느", 90, 120, new Stupefy("Stupefy", 40, 30),"Hermione.png");
		...
		ronPicture1.setIcon(new ImageIcon(GameActView.class.getResource("/image/Ron.png")));
		...
		ronButton1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				p1 = new Ron("론", 110, 80, new Protego("Protego", 25, 20),"Ron.png");
		...
		harryPicture1.setIcon(new ImageIcon(GameActView.class.getResource("/image/Harry.png")));
		...
		harryButton1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				p1 = new Harry("해리", 100, 90, new Expelliarmus("Expelliarmus", 50, 40),"Harry.png");
		...
		dracoPicture2.setIcon(new ImageIcon(GameActView.class.getResource("/image/Draco.png")));
		...
		dracoButton2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				p2 = new Draco("드레이코", 95, 100, new ExpectoPatronum("ExpectoPatronum", 15, 10),"Draco.png");
		...
		harryPicture2.setIcon(new ImageIcon(GameActView.class.getResource("/image/Harry.png")));
		...
		harryButton2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				p2 = new Harry("해리", 100, 90, new Expelliarmus("Expelliarmus", 50, 40),"Harry.png");
		...
		hermionePicture2.setIcon(new ImageIcon(GameActView.class.getResource("/image/Hermione.png")));
		...
		hermioneButton2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				p2 = new Hermione("헤르미온느", 90, 120, new Stupefy("Stupefy", 40, 30),"Hermione.png");
		...
		ronPicture2.setIcon(new ImageIcon(GameActView.class.getResource("/image/Ron.png")));
		...
		ronButton2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				p2 = new Ron("론", 110, 80, new Protego("Protego", 25, 20),"Ron.png");
